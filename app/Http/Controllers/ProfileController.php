...
class ProfileController extends Controller
{
    ...
    {
        $vehicles = Vehicle::where(['user_id' => Auth::user()->id])->with('year', 'maker', 'model', 'sku', 'store', 'tags', 'features')->paginate(5);

        return view('web.profile', compact('vehicles'));
    }
    ...
    {
        return view('web.vehicle.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('web.vehicle.show', compact('vehicle'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('web.vehicle.edit', compact('vehicle'));
    }
